...
<div id="intro">
    <div id="intro_wrap">
        <div class="container_12">
            ...
            <h1><?php echo $sub_category->sub_category_name; ?></h1>
        </div>
    </div>
</div>
<!-- END OF INTRO -->
            ...
            <?php foreach ($category_product as $v_product) { ?>
                <div class="s_item grid_3"><a class="s_thumb" href="<?php echo base_url();?>welcome/product_details/<?php echo $v_product->product_id;?>"><img src="<?php echo base_url().$v_product->product_photo_0;?>" title="" alt="" /></a>
                    ...
                    <?php
                        ...
                        switch ($currency) {
                            case 'BDT':
                            $price = $v_product->product_price_in_bdt;
                            break;
                        
                            case 'USD':
                            $price = $v_product->product_price_in_usd;
                            break;
                        
                            case 'EURO':
                            $price = $v_product->product_price_in_euro;
                            break;
                        
                            case 'GBP':
                            $price = $v_product->product_price_in_gbp;
                            break;
                        }
                    ?>
                    <p class="s_price"><span class="s_currency s_before"><?php echo $currency;?><strong>. </strong></span><strong><?php echo $price;?></strong></p>
                    <a class="s_button_add_to_cart" href="<?php echo base_url();?>welcome/product_details/<?php echo $v_product->product_id;?>"><span class="s_icon_16"><span class="s_icon"></span>Add to Cart</span></a>
                </div>
            <?php } ?>            
            <div class="clear"></div>
        </div>
